...
import animationLogin from '../../../assets/singup.gif'
            ...
            <div className="hero-content flex-col lg:flex-row ">
                ...
                <div className=" flex-shrink-0 w-full max-w-sm shadow-2xl bg-gray-100 p-5 rounded-3xl">
                    ...
                    <label className="p-10">
                        <p className='text-center'>Already have an account ? <Link to="/login" className="text-[#FF42A5] link link-hover">Login Now!</Link></p>
                    </label>
